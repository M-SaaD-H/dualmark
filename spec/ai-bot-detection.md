...
The reference implementation publishes the registry as `AI_BOTS` in [`@dualmark/core`](../packages/core/src/bots.ts). Implementations MAY consume this directly, mirror it, or maintain their own extensions.
