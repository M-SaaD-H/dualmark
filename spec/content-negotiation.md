...
A conformant server MAY also serve markdown when the request `User-Agent` matches an entry in the [AI Agent Registry](./ai-bot-detection.md). This is an OPTIONAL extension to RFC 7231 negotiation; servers that choose to do this:
