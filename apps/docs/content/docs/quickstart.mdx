...
<Tabs items={["Astro", "Next.js", "Nuxt", "Cloudflare Workers", "Any framework"]}>
...
Add Dualmark to your Nuxt config.
...
Every blog post now has a markdown twin at `/blog/<slug>.md`, an `llms.txt` is auto-generated, and a Nitro plugin injects `Link: <…>; rel="alternate"; type="text/markdown"` on every HTML response.

Expect **Score 125/125** under `nuxt dev`.

</Step>

</Steps>

→ [Full Nuxt reference](/docs/integrations/nuxt)
