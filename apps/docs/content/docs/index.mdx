...
import { AstroLogo, NextLogo, CloudflareLogo, NuxtLogo } from "@/components/brand-logos";
...
<Cards>
  ...
  <Card icon={<NuxtLogo />} title="Nuxt" href="/docs/integrations/nuxt" description="Zero-config integration for Nuxt 3. Auto-generates .md routes, middleware, and llms.txt." />
...
<Cards>
  ...
  <Card icon={<NuxtLogo />} title="@dualmark/nuxt" href="/docs/packages/nuxt" description="Nuxt 3 integration with auto-generated routes, middleware, and llms.txt." />
