...
import { AstroLogo, NextLogo, CloudflareLogo, NetlifyLogo } from "@/components/brand-logos";
...
<Cards>
  ...
  <Card icon={<NetlifyLogo />} title="Netlify" href="/docs/integrations/netlify" description="Edge Functions adapter. Transparently serves markdown twin to AI agents." />
...
<Cards>
  ...
  <Card icon={<NetlifyLogo />} title="@dualmark/netlify" href="/docs/packages/netlify" description="Netlify Edge Functions adapter. Transparently serves markdown to AI bots at the edge." />
